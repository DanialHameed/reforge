...
import { Loader2, FilePenLine, CalendarClock } from "lucide-react";
    ...
    <PageTransition>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-slate-600">
          A high-signal overview of your content pipeline.
        </p>
      </div>
      ...
      <div className="mt-6 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <motion.div whileTap={{ scale: 0.95 }}>
            <Link
              href="/content/upload"
              className="rounded-xl bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800 transition-all duration-200"
            >
              Upload
            </Link>
          </motion.div>
          <motion.div whileTap={{ scale: 0.95 }}>
            <Link
              href="/content"
              className="rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-900 hover:bg-slate-50 transition-all duration-200"
            >
              View all
            </Link>
          </motion.div>
